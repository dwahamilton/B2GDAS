...
def plot_mttbar(argv) :
    ...
    for itree,t in enumerate(trees) :
        ...
        for jentry in xrange( eventsToRun ):
            ...
            h_mttbar.Fill( mttbar, SemiLeptWeight[0]/GenWeight[0] )
            #h_mtopHadGroomed.Fill( mass_sd, SemiLeptWeight[0]/GenWeight[0] )
            #h_mtopHad.Fill( hadTopCandP4.M(), SemiLeptWeight[0]/GenWeight[0] )
            #h_SemiLeptTrig.Fill( SemiLeptTrig[0], SemiLeptWeight[0]/GenWeight[0] )
            #h_SemiLeptWeight.Fill( SemiLeptWeight[0], SemiLeptWeight[0]/GenWeight[0] )
            #h_PUWeight.Fill( PUWeight[0], SemiLeptWeight[0]/GenWeight[0] )
            #h_GenWeight.Fill( GenWeight[0], SemiLeptWeight[0]/GenWeight[0] )
            h_FatJetPt.Fill( FatJetPt[0], SemiLeptWeight[0]/GenWeight[0] )
            h_FatJetEta.Fill( FatJetEta[0], SemiLeptWeight[0]/GenWeight[0] )
            h_FatJetPhi.Fill( FatJetPhi[0], SemiLeptWeight[0]/GenWeight[0] )
            h_FatJetRap.Fill( FatJetRap[0], SemiLeptWeight[0]/GenWeight[0] )
            h_FatJetEnergy.Fill( FatJetEnergy[0], SemiLeptWeight[0]/GenWeight[0] )
            h_FatJetBDisc.Fill( FatJetBDisc[0], SemiLeptWeight[0]/GenWeight[0] )
            h_FatJetMass.Fill( FatJetMass[0], SemiLeptWeight[0]/GenWeight[0] )
            h_FatJetMassSoftDrop.Fill( FatJetMassSoftDrop[0], SemiLeptWeight[0]/GenWeight[0] )
            h_FatJetTau32.Fill( FatJetTau32[0], SemiLeptWeight[0]/GenWeight[0] )
            #h_FatJetTau21.Fill( FatJetTau21[0], SemiLeptWeight[0]/GenWeight[0] )
            #h_FatJetSDBDiscW.Fill( FatJetSDBDiscW[0], SemiLeptWeight[0]/GenWeight[0] )
            h_FatJetSDBDiscB.Fill( FatJetSDBDiscB[0], SemiLeptWeight[0]/GenWeight[0] )
            h_FatJetSDsubjetWpt.Fill( FatJetSDsubjetWpt[0], SemiLeptWeight[0]/GenWeight[0] )
            h_FatJetSDsubjetWmass.Fill( FatJetSDsubjetWmass[0], SemiLeptWeight[0]/GenWeight[0] )
            h_FatJetSDsubjetBpt.Fill( FatJetSDsubjetBpt[0], SemiLeptWeight[0]/GenWeight[0] )
            h_FatJetSDsubjetBmass.Fill( FatJetSDsubjetBmass[0], SemiLeptWeight[0]/GenWeight[0] )
            #h_FatJetJECUpSys.Fill( FatJetJECUpSys[0], SemiLeptWeight[0]/GenWeight[0] )
            #h_FatJetJECDnSys.Fill( FatJetJECDnSys[0], SemiLeptWeight[0]/GenWeight[0] )
            #h_FatJetJERUpSys.Fill( FatJetJERUpSys[0], SemiLeptWeight[0]/GenWeight[0] )
            #h_FatJetJERDnSys.Fill( FatJetJERDnSys[0], SemiLeptWeight[0]/GenWeight[0] )
            #h_LeptonType.Fill( LeptonType[0], SemiLeptWeight[0]/GenWeight[0] )
            h_LeptonPt.Fill( LeptonPt[0], SemiLeptWeight[0]/GenWeight[0] )
            h_LeptonEta.Fill( LeptonEta[0], SemiLeptWeight[0]/GenWeight[0] )
            h_LeptonPhi.Fill( LeptonPhi[0], SemiLeptWeight[0]/GenWeight[0] )
            h_LeptonEnergy.Fill( LeptonEnergy[0], SemiLeptWeight[0]/GenWeight[0] )
            h_LeptonIso.Fill( LeptonIso[0], SemiLeptWeight[0]/GenWeight[0] )
            h_LeptonPtRel.Fill( LeptonPtRel[0], SemiLeptWeight[0]/GenWeight[0] )
            #h_LeptonDRMin.Fill( LeptonDRMin[0], SemiLeptWeight[0]/GenWeight[0] )
            h_SemiLepMETpt.Fill( SemiLepMETpt[0], SemiLeptWeight[0]/GenWeight[0] )
            h_SemiLepMETphi.Fill( SemiLepMETphi[0], SemiLeptWeight[0]/GenWeight[0] )
            h_SemiLepNvtx.Fill( SemiLepNvtx[0], SemiLeptWeight[0]/GenWeight[0] )
            h_FatJetDeltaPhiLep.Fill( FatJetDeltaPhiLep[0], SemiLeptWeight[0]/GenWeight[0] )
            h_NearestAK4JetBDisc.Fill( NearestAK4JetBDisc[0], SemiLeptWeight[0]/GenWeight[0] )
            h_NearestAK4JetPt.Fill( NearestAK4JetPt[0], SemiLeptWeight[0]/GenWeight[0] )
            h_NearestAK4JetEta.Fill( NearestAK4JetEta[0], SemiLeptWeight[0]/GenWeight[0] )
            h_NearestAK4JetPhi.Fill( NearestAK4JetPhi[0], SemiLeptWeight[0]/GenWeight[0] )
            h_NearestAK4JetMass.Fill( NearestAK4JetMass[0], SemiLeptWeight[0]/GenWeight[0] )
            #h_NearestAK4JetJECUpSys.Fill( NearestAK4JetJECUpSys[0], SemiLeptWeight[0]/GenWeight[0] )
            #h_NearestAK4JetJECDnSys.Fill( NearestAK4JetJECDnSys[0], SemiLeptWeight[0]/GenWeight[0] )
            #h_NearestAK4JetJERUpSys.Fill( NearestAK4JetJERUpSys[0], SemiLeptWeight[0]/GenWeight[0] )
            #h_NearestAK4JetJERDnSys.Fill( NearestAK4JetJERDnSys[0], SemiLeptWeight[0]/GenWeight[0] )
            #h_SemiLeptRunNum.Fill( SemiLeptRunNum[0], SemiLeptWeight[0]/GenWeight[0] )
            #h_SemiLeptLumiNum.Fill( SemiLeptLumiNum[0], SemiLeptWeight[0]/GenWeight[0] )
            #h_SemiLeptEventNum.Fill( SemiLeptEventNum[0], SemiLeptWeight[0]/GenWeight[0] )
